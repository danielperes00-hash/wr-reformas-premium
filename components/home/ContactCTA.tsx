    ...
    <section className="relative py-32 bg-obsidian overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-silver text-lg font-light max-w-xl mx-auto mb-12 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <Link href="/contato" className="btn-outline inline-flex items-center gap-2 text-sm">
